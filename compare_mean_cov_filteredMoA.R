...
cr.melt.mean %<>% remove_moa_with_few_pairs()
cr.melt.cov %<>% remove_moa_with_few_pairs()
cr.melt.mad %<>% remove_moa_with_few_pairs()
cr.melt.median.mad.2 %<>% remove_moa_with_few_pairs() 
FA.cr.melt.mean %<>% remove_moa_with_few_pairs()
FA.cr.melt.median %<>% remove_moa_with_few_pairs() 
FA.cr.melt.mad %<>% remove_moa_with_few_pairs()
pc.cr.melt.mean %<>% remove_moa_with_few_pairs()
pc.cr.melt.median %<>% remove_moa_with_few_pairs()
pc.cr.melt.mad %<>% remove_moa_with_few_pairs() 
...
cm.rn <-setdiff(intersect(int, int1), NA)
...
pc.cr.mean[is.na(FA.cr.mean)] <- 0
pc.cr.median[is.na(FA.cr.median)] <- 0
pc.cr.mad[is.na(FA.cr.mad)] <- 0
