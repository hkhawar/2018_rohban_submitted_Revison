#setwd("~/Desktop/stuff/Mohammad_paper/Bioactives-BBBC022-Gustafsdottir/code/")
setwd("~/Desktop/stuff/Mohammad_paper/CDRP/code/")
#setwd("~/Desktop/stuff/Mohammad_paper/TA/code/")
